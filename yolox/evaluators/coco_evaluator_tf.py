...
class COCOEvaluator:
    ...
    def __init__(
        ...
        Args:
            ...
            nmsthre: IoU threshold of non-max suppression ranging from 0 to 1.
            per_class_AP: Show per class AP during evaluation or not. Default to True.
            per_class_AR: Show per class AR during evaluation or not. Default to True.
        """
    ...
    def convert_to_coco_format(
        self, outputs, info_imgs, ids, return_outputs=False
    ):
        data_list = []
        # print(outputs.size, info_imgs.size, ids.size)
